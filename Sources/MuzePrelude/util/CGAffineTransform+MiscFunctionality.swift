...
public extension CGAffineTransform {
    ...
    /// returns a rotation invariant heightScale. Rotations cause the normal heightScale
    ///  to be with respect to the bounding box of the thing being transformed. If you want
    ///  to know how much the actual content height itself is being stretched (which is
    ///   equivalent to heightScale when the rotation is 0), use this.
    var unrotatedHeightScale: CGFloat {
        return self.withoutRotation.heightScale
    }
    
    /// returns a rotation invariant widthScale. Rotations cause the normal widthScale to
    ///  be with respect to the bounding box of the thing being transformed. If you want
    ///  to know how much the actual content width itself is being stretched (which is
    ///   equivalent to widthScale when the rotation is 0), use this.
