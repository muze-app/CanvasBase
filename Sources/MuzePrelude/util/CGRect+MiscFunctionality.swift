...
public extension CGRect {
    ...
    /// returns what the size would be were it to have no rotation transform. The angle
    ///  input should be based upon a CGAffineTransform, the specific function being:
    ///     'angle = atan2(transform.b, transform.a)'.
    ///  NOTE: You should probably use the UIView version if available because it is
    ///  simpler and faster.
    ...
    /// returns what the frame would be were it to have no rotation transform. The angle
    ///  input should be based upon a CGAffineTransform, the specific function being:
    ///      'angle = atan2(transform.b, transform.a)'.
    ///  NOTE: You should probably use the UIView version if available because it is
    ///  simpler and faster.
