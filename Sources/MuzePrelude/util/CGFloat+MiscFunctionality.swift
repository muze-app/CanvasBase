...
public extension CGFloat {
    ...
    func mappedProportionally(from r0: (CGFloat, CGFloat),
        ...
        /// y = (x-a)(d-c)/(b-a) + c describes any one-dimensional range transformation
        ///  consisting of scaling and shifting, where x is a point in the original range [a,b]
        ///   and y is its mapped correspondent in the transformed range [c,d]. The func
        ///    returns y where self = x.
        /// a, b, c, and d are all coordinates within a single one-dimensional system Z.
        /// Here's an example visualization of the transformation:
        ///  before:  0 - - a---x------b - - - - - - - - - - - - - - - -> Z
        ///   after:  0 - - - - - - - - - - c------y------------d - - - > Z
