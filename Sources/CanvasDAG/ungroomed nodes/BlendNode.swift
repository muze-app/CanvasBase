...
//struct BlendPayload: NodePayload {
//    var a: BlendMode
//    var b: Float
//    init(_ a: BlendMode, _ b: Float) { self.a = a; self.b = b }
//}

//final class BlendNode: PNode<BlendPayload> {
//    
//    init(_ key: NodeKey = NodeKey(), graph: DAG, payload: BlendPayload? = nil) {
...
//    // MARK: Blend
//    
//    func blend(source: RenderPayload, destination: RenderPayload, options: RenderOptions) -> RenderPayload {
//        
...
//    // MARK: Composite
//    
//    func composite(source: RenderPayload, destination: RenderPayload?, options: RenderOptions) -> RenderPayload {
