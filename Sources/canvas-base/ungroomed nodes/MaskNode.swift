...
//
//final class MaskNode: PNode<MaskMode> {
//
...
//extension MaskNode {
//
//    typealias TempType = DNode // should be DNode
//
//    var myMasks: [(MaskMode, TempType?)] {
//        guard let mask = self.mask else {
//            return []
//        }
//
//        if let series = mask as? MaskSeriesNode {
//            let pairs: [(MaskMode, TempType?)] = series.pairs.map { ($0.0, ($0.1 as! TempType)) }
//
...
//        }
//
//        return (myMasks, myInput as! TempType)
//    }
//
//}
//
